...
<!-- END .header -->
	<div id="fh5co-main">
        ...
        <div id="fh5co-board" data-columns>
          <?php
            $tid = $_GET['tid'];
            $query = "select * from post natural join content  where tid='$tid' and vis=1";
          ...
          ?>
        	...
        	<div class="item">
        		<div class="animate-box">
	        		<a href="content.php?pid=<?php echo $row['pid'];?>&tid=<?php echo $tid ?>" title="Kwynch - Topics"><img src="<?php echo urldecode($row['img']);?>" alt="Kwynch Topics"></a>
        		</div>
        		<div class="fh5co-desc"><?php echo $row['title'];?></div>
        	</div>
        <?php } ?>
        </div>
        </div>
