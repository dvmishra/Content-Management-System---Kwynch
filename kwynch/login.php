...
<div class="container-fluid" style="margin-bottom:-50px;">
  <form class="form-signin" method="post" action="process.php">
    <h2 style="color:#000; font-size:30px;">Please login</h2>
    <br><input type="text" class="form-control" name="username" placeholder="Email Address" required="" autofocus="" />
    ...
    <br>
    <button type="submit" name="submit" class="btn btn-lg btn-primary " style="width:100%;">Login</button>
    <button type="submit" name="submit1" class="btn btn-lg btn-primary " style="width:100%;">Login as Admin</button>
  </form>
</div>
